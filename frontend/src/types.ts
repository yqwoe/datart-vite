...
import { JobState } from 'app/pages/MainPage/pages/ExtractPage/JobDetailPage/slice/types';
import { MappingState } from 'app/pages/MainPage/pages/ExtractPage/MappingDetailPage/slice/types';
import { MetaState } from 'app/pages/MainPage/pages/ExtractPage/MetaDetailPage/slice/types';
