...
export const AddController: React.FC<AddControlBtnProps> = () => {
    ...
    items: [
      {
        ...
        type: 'group',
        children: conventionalControllers.map(({ icon, type }) => ({
          key: type,
          icon,
          label: tFilterName(type),
        })),
      },
      {
        ...
        key: 'dateControllers',
        type: 'group',
        children: dateControllers.map(({ icon, type }) => ({
          key: type,
          icon,
          label: tFilterName(type),
        })),
      },
      {
        ...
        type: 'group',
        children: numericalControllers.map(({ icon, type }) => ({
          key: type,
          icon,
          label: tFilterName(type),
        })),
      },
      {
        ...
        key: 'buttons',
        type: 'group',
        children: buttons.map(({ icon, type }) => ({
          key: type,
          icon,
          label: tWt(type),
        })),
  ...
  return (
    <Dropdown menu={controlerItems} placement="bottomLeft" trigger={['click']}>
