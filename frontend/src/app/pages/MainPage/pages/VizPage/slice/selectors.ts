...
export const makeSelectStoryboardTree = () =>
  createSelector(
    [
      selectStoryboards,
...
export const makeSelectStoryboardFolderTree = () =>
  createSelector(
    [
      selectStoryboards,
      (_, props: SelectStoryboardFolderTree) => props.id,
      (_, props: SelectStoryboardFolderTree) => props.getDisabled,
    ],
