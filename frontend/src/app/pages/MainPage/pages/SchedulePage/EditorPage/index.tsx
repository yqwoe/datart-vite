...
import { DingtalkSetttingForm } from './DingtalkSetttingForm';
...
export const EditorPage: FC = () => {
  ...
  const params = useParams<{ scheduleId: string; orgId: string }>();
  ...
  const onFinish = useCallback(() => {
    form.validateFields().then((values: FormValues) => {
      ...
      const index = getInsertedNodeIndex(values, schedules);
          ...
          >
            <FormAreaWrapper>
              ...
              {jobType === JobTypes.Email && (
                <FormCard title={t('emailSettings')}>
                  <FormWrapper>
                    <EmailSettingForm
                      fileType={fileType}
              ...
              {jobType === JobTypes.Dingtalk && (
                <FormCard title={t('dingtalkSettings')}>
                  <FormWrapper>
                    <DingtalkSetttingForm />
                  </FormWrapper>
                </FormCard>
              )}
