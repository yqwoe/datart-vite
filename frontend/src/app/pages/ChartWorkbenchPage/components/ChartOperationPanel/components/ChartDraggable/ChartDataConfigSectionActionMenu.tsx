...
import CalcAction from '../ChartFieldAction/CalcAction';
import DateRatioAction from '../ChartFieldAction/DateRatioAction';
...
> = ({
  ...
  const subMenuAction = [
    ...
    ChartDataSectionFieldActionType.Calc,
  ...
  const getSubMenuActionComponent = (actionName, uid) => {
    ...
    if (actionName === ChartDataSectionFieldActionType.Calc) {
      return (
        <CalcAction
          uid={uid}
          config={fieldConfig}
    ...
    if (actionName === ChartDataSectionFieldActionType.DateRatio) {
      return (
        <DateRatioAction
          config={fieldConfig}
          onConfigChange={(config, needRefresh) => {
