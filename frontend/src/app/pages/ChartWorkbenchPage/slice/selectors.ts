...
import { SelectViewTreeProps } from 'app/pages/MainPage/pages/ViewPage/slice/types';
...
export const makeDataviewTreeSelector = () =>
  createSelector(
    [
      dataviewsSelector,
      (_, getIcon: (o: ChartDataView) => boolean) => getIcon,
      (_, getSelectable: (o: ChartDataView) => boolean) => getSelectable,
    ],
    (dataviews, getIcon, getSelectable) =>
      listToTree(dataviews, null, [ResourceTypes.View], {
        getIcon,
        getSelectable,
      }),
  );
