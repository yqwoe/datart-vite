...
class BasicTableChart extends ReactChart {
    ...
    Debugger.instance.measure(
      ...
      () => {
        ...
        this.adapter?.updated(
          { ...tableOptions, containerId: options.containerId },
          context,
        );
      },
      false,
  ...
  protected getOptions(
    ...
    return {
      rowKey: record => chartDataSet.findIndex(e => record == e),
  ...
  protected getTableComponents(
    ...
    return {
      header: {
        cell: props => {
          const uid = props.uid;
          const { style, title,columnIndex, ...rest } = props;
