...
export function isInRange(limit?: ChartDataConfig['limit'], count = 0) {
  return cond(
    [isEmpty, true],
...
export function isUnderUpperBound(limit?: ChartDataConfig['limit'], count = 0) {
  return cond(
    [isEmpty, true],
