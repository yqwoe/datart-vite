...
export function Navbar() {
  ...
  const matchModules = useMatch('/organizations/:orgId/:moduleName');
  ...
  const navs = useMemo(
    () => [
      ...
      },
      {
        ...
        className: location.pathname.match(
  ...
  const showSubNav = useMemo(
    () => subNavs.some(({ name }) => name === matchModules?.moduleName),
    [matchModules?.moduleName, subNavs],
  );
  ...
  return (
    <>
      <MainNav>
        ...
        <Nav>
          {navs.map(({ name, title, icon, className, module }, i) => {
            ...
            >
              <li>
                <Tooltip title={t('nav.organization.title')} placement="right">
                  <Avatar src={currentOrganization?.avatar}>
                    <BankFilled />
                  </Avatar>
                </Tooltip>
              </li>
        ...
        <SubNav>
          <List
            ...
            renderItem={({ name, title, icon }) => (
              <SubNavTitle key={name} to={`/organizations/${orgId}/${name}`}>
