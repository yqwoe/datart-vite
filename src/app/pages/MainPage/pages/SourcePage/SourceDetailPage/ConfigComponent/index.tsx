...
import { ExtractSchemaComponent } from './ExtractSchemaComponent';
...
interface ConfigComponentProps {
  ...
  onDependencyChange?: (val: any) => void;
}
...
export function ConfigComponent({
  ...
  const extraFormItemProps: Partial<FormItemProps> = {};
    ...
    default:
      switch (type) {
            ...
            if (options.length > 3) {
              component = (
                <Select
                  ...
                  showSearch
                  allowClear
                  onChange={e => onDependencyChange && onDependencyChange(e)}
                >
                  {options.map(o => (
              ...
              component = (
                <Radio.Group
                  disabled={disabled}
                  onChange={e =>
                    onDependencyChange && onDependencyChange(e.target?.value)
                  }
                >
                  {options.map(o => (
                    <Radio key={o} value={o}>
        ...
        case 'object':
          ...
          extraFormItemProps.wrapperCol = { span: 24 };
          break;
        case 'array':
        case 'files':
          component = (
        ...
        case 'schema':
          component = (
            <SchemaComponent form={form} dataSource={schemaDataSource} />
          );
          extraFormItemProps.wrapperCol = { span: 16 };
          break;
        case 'mockSchema':
          component = (
            <ExtractSchemaComponent form={form} dataSource={schemaDataSource} />
          );
          extraFormItemProps.wrapperCol = { span: 16 };
          break;
        case 'number':
