...
const ChartGraphIcon: FC<{
  ...
  const renderChartRequirements = requirements => {
    const lintMessages = requirements?.flatMap((requirement, index) => {
      return [
        ChartDataSectionType.Lng,
        ChartDataSectionType.Lat,
        ChartDataSectionType.Date,
        ChartDataSectionType.Row,
        ChartDataSectionType.Column,
        ChartDataSectionType.Source,
        ChartDataSectionType.Target,
        ChartDataSectionType.Relation,
