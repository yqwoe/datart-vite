      ...
      rows: [
        ...
        },
        {
          ...
          options: {
            translateItemLabel: true,
            items: [
              { label: '@global@.scroll.up', value: 'up' },
              { label: '@global@.scroll.down', value: 'down' },
              { label: '@global@.scroll.left', value: 'left' },
              { label: '@global@.scroll.right', value: 'right' },
            ],
          },
        },
        {
    ...
    },
    {
      ...
      translation: {
        ...
        style: {
          ...
          enableProgress: 'Enable Progress Bar',
          device: 'Device',
          metricNameShowIn: {
