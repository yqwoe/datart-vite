...
public class MysqlDialect extends MysqlSqlDialect implements SqlStdOperatorSupport, FetchAndOffsetSupport {
    ...
    public MysqlDialect() {
        this(MysqlDialect.DEFAULT_CONTEXT.withUnquotedCasing(Casing.UNCHANGED).withUnquotedCasing(Casing.UNCHANGED));
    }
