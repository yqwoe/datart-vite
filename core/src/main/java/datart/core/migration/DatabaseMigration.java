...
public class DatabaseMigration {
    ...
    @Value("${spring.datasource.url:jdbc:mysql://127.0.0.1:3306/datart2?allowMultiQueries=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false}")
    private String url;
