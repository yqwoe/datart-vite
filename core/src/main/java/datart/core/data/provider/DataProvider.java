...
public abstract class DataProvider extends AutoCloseBean {
    ...
    public DataProviderInfo getBaseInfo() throws IOException {
        ...
        dataProviderInfo.setExtract(template.getExtract());
    ...
    public abstract Set<TableInfo> readTableInfos(DataProviderSource source, String database);

    public abstract Set<Column> readTableColumns(DataProviderSource source, String schema, String table) throws SQLException;

    public abstract Set<Column> readTableColumnInfos(DataProviderSource source, String table);

    public abstract Set<Column> readTableColumnsBySql(DataProviderSource source, String sql);

    public abstract boolean createTable(DataProviderSource target, String table, Set<Column> columns);
     ...
     * @return
     */
    public abstract boolean callFunction(DataProviderSource source, String function);
