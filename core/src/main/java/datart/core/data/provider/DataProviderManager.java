...
public interface DataProviderManager {
    ...
    Set<TableInfo> readTableInfos(DataProviderSource source, String database);

    Set<Column> readTableColumns(DataProviderSource source, String schema, String table) throws SQLException;

    Set<Column> readTableColumnInfos(DataProviderSource source, String table);

    Set<Column> readTableColumnsBySql(DataProviderSource source, String sql);

    boolean createTable(DataProviderSource target, String table,Set<Column> columns);
    ...
    boolean callFunction(DataProviderSource source, String function);
