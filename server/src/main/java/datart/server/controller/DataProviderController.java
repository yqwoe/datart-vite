...
public class DataProviderController extends BaseController {
    ...
    @ApiOperation(value = "List tables")
    @GetMapping(value = "/{sourceId}/{database}/tableInfos")
    public ResponseData<Set<TableInfo>> listTableInfos(@PathVariable String sourceId,
                                                @PathVariable String database) {
        checkBlank(sourceId, "sourceId");
        checkBlank(database, "database");
        return ResponseData.success(dataProviderService.readTableInfos(sourceId, database));
    }
    ...
    @ApiOperation(value = "Get table Info")
    @GetMapping(value = "/{sourceId}/columnInfosBySql")
    public ResponseData<Set<Column>> getTableInfoBySql(@PathVariable String sourceId,
                                                  @RequestParam String sql) {
        return ResponseData.success(dataProviderService.readTableColumnsBySql(sourceId, sql));
    }
    ...
    @ApiOperation(value = "Test data source call function")
    @PostMapping(value = "/call/{sourceId}")
    public ResponseData<Boolean> testCallFunction(@PathVariable String sourceId,String func) throws Exception {
        return ResponseData.success(dataProviderService.callFunction(sourceId,func));
    }
