...
public class FileController extends BaseController {
    ...
    @ApiOperation(value = "upload user avatar")
    @PostMapping(value = "/data-mapping")
    public ResponseData<String> uploadMappingFile(@RequestParam String dataId,
                                                     @RequestParam("file") MultipartFile file) throws IOException {
        return ResponseData.success(fileService.uploadFile(FileOwner.DATA_MAPPING, dataId, file, null));
    }
