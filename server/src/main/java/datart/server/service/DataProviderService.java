...
public interface DataProviderService {
    ...
    Set<TableInfo> readTableInfos(String sourceId, String database);

    Set<Column> readTableColumns(String sourceId, String schema, String table) throws SQLException;

    Set<Column> readTableColumnInfos(String sourceId, String table);

    Set<Column> readTableColumnsBySql(String sourceId,String sql);
    ...
    boolean callFunction(String sourceId, String function);
