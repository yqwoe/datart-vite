...
public class RoleServiceImpl extends BaseService implements RoleService {
    ...
    @Override
    public boolean updateRolesForUser(String userId, String orgId, Set<String> roleIds, boolean checkPermision) {
    ...
    public boolean updateRolesForUser(String userId, String orgId, Set<String> roleIds) {
        return updateRolesForUser(userId,orgId,roleIds,true);
    }
